...
<template>
    <div>
        ...
        >
            <div
                v-show="showModal"
                class="fixed inset-0 bg-slate-900 bg-opacity-30 z-30 transition-opacity"
                aria-hidden="true"
            ></div>
        </transition>
        <transition
        ...
        >
            ...
            >
                <div
                    ref="modalContent"
                    class="bg-white rounded shadow-lg w-full h-full no-scrollbar overflow-hidden"
                    :class="{
                        'max-w-[438px]': mobile,
                        'max-w-sm': size === 'sm',
                        'max-w-md': size === 'md',
                ...
                >
                    ...
                    <div
                        class="px-5 py-4 overflow-y-hidden max-h-full flex justify-center items-center"
                    >
                        <slot name="content" />
                    </div>
                </div>
